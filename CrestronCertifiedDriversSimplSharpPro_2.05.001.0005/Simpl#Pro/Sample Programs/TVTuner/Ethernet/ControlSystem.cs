...
namespace RadTvTunerEthernetExample
{
    public class ControlSystem : CrestronControlSystem
    {
        ...
        private void CreateDriver(string filename, string ipAddress)
        {
            ...
            _device = GetAssembly<IBasicCableBox>(filename, "IBasicCableBox", "ITcp");
        ...
        private readonly string _panelSgdFilename = Directory.GetApplicationDirectory() + "\\CCD TVTuner Ethernet Example Project.sgd";
