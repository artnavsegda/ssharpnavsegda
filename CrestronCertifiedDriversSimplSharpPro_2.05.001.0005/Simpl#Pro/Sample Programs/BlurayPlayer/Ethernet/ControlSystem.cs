...
namespace RadBlurayPlayerEthernetExample
{
    public class ControlSystem : CrestronControlSystem
    {
        ...
        private void CreateDriver(string filename, string ipAddress)
        {
            ...
            _device = GetAssembly<IBasicBlurayPlayer>(filename, "IBasicBlurayPlayer", "ITcp");
        ...
        private readonly string _panelSgdFilename = Directory.GetApplicationDirectory() + "\\CCD BlurayPlayer Ethernet Example Project.sgd";
