...
namespace RadVideoServerEthernetExample
{
    public class ControlSystem : CrestronControlSystem
    {
        ...
        private void CreateDriver(string filename, string ipAddress)
        {
            ...
            _device = GetAssembly<IBasicVideoServer>(filename, "IBasicVideoServer", "ITcp");
        ...
        private readonly string _panelSgdFilename = Directory.GetApplicationDirectory() + "\\RAD VideoServer Ethernet Example Project.sgd";
