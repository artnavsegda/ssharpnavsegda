...
namespace RadDisplaySerialExample
{
    public class ControlSystem : CrestronControlSystem
    {
        ...
        private void CreateDriver(string filename, uint comPortNumber)
        {
            ...
            _device = GetAssembly<IBasicVideoDisplay>(filename, "IBasicVideoDisplay", "ISerialComport");
            if (_device != null)
            {
                // Set up hardware
        ...
        private readonly string _panelSgdFilename = Directory.GetApplicationDirectory() + "\\CCD Display Serial Example Project.sgd";
